...
export default function ApplicationItem({ href, title }: ApplicationItemProps) {
	return (
		<Link href={`${usePathname()}/${href}`}>
			<li className='flex flex-col w-48 h-48 bg-primary-50 rounded-3xl transition-scale duration-100 ease-in-out hover:bg-primary-100 active:scale-95 cursor-default'>
